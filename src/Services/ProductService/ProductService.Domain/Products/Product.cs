// <copyright file="Product.cs" company="SneakerCollector">
...
using SneakerCollector.Services.ProductService.Domain.Products.Dtos;
using SneakerCollector.Services.ProductService.Domain.Products.Validators;
...
namespace SneakerCollector.Services.ProductService.Domain.Products;
