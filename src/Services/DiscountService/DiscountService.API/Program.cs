...
var builder = WebApplication.CreateBuilder(args);
{
    ...
    builder.Services.AddSwaggerGen(options =>
    {
        ...
        {
            Version = "v1",
            Title = "SneakerCollector - Discount Service Api",
            Description = "The Discount Service Api is part of the SneakerCollector Distributed Application backend, and it provides functionalities for fetching the Discount Amount for the given Product Ids.",
        });
    });
}
