...
Sneaker Collector is a Cloud Native Containerized Distributed System built for scaling using .NET Core and PostgreSQL as the primary data storage. 
...
```shell
git clone https://github.com/tessarolli/SneakerCollector.git
```

2. **Enter the SneakerCollector Directory:**
...
```shell
dotnet restore SneakerCollector.sln
```
...
The architecture of Sneaker Collector emphasizes modularity, scalability, and maintainability, enabling the development of robust, distributed systems capable of handling complex business requirements. 
By adhering to best practices and leveraging modern technologies, Sneaker Collector delivers a reliable and scalable solution for managing user authentication, user management, and product catalog management.
